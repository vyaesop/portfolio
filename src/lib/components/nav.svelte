			...
			<div class="wrapper" class:mobileMenuActive>
				<ul class="nav-list">
					{#key mobileMenuActive}
						...
						<li class="mobile">
							<a href="https://www.linkedin.com/in/olyad-kassim" target="_blank" in:mobileTransitionSwitcher={{ delay: 350 }}>LinkedIn</a>
						</li>
						<li use:introAnimation={{ delay: 1300 }}>
							<a href="https://github.com/vyaesop" target="_blank" in:mobileTransitionSwitcher={{ delay: 400 }}>GitHub</a>
						</li>
					{/key}
				</ul>
			</div>
