    ...
    <div class="flex-wrapper">
        ...
        <div class="status-wrapper">
            {#if dataState.siteData}
                ...
                {:else}
                    <p class="large-text" bind:this={statusElement}>
                        i am available for new opportunities after <br> {dataState.siteData.availablity_date}.
                    </p>
                {/if}
            {/if}
            <a class="button large-text" bind:this={fullEmailLinkElement} href="https://www.linkedin.com/in/olyad-kassim" target="_blank">linkedin.com/in/olyad-kassim</a>
        </div>
        
        <div class="credits-wrapper" bind:this={creditsElement}>
            <p class="year">© {currentYear}</p>
            <p class="credits">
                designed and developed by Olyad Kassim<br>
                
                <!-- Support the project by keeping this line in your fork -->
                <a class="clickable button no-decor" href="https://github.com/vyaesop" target="_blank">
