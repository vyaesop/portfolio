	...
	{#await sectionOnePromise then _}
		<div class="content-wrapper">
			...
			<div in:maskSlideIn={{ duration: 1200, reverse: true, delay: 150 }}>
				<p class="paragraph">
					Senior Software Engineer with 7+ years of experience building scalable, high-performance web and mobile applications. I design and deliver production-grade systems using Python, TypeScript, .NET and cloud-native architectures. I focus on performance, clean architecture, and reliable cross-platform experiences.
					<br><br>
					Houston, TX
				</p>
			</div>
			<div class="social-button-wrapper">
				<div in:maskSlideIn={{ delay: 250, reverse: true }}>
					<span class="button"><a href="mailto:vyaesop@gmail.com" target="_blank" class="clickable sublink link">Email</a></span>
				</div>
				<div in:maskSlideIn={{ delay: 450, reverse: true }}>
					<span class="button"><a href="tel:+14435797719" target="_blank" class="clickable sublink link">+1 (443) 579‑7719</a></span>
				</div>
				<div in:maskSlideIn={{ delay: 650, reverse: true }}>
					<span class="button"><a href="https://www.linkedin.com/in/olyad-kassim" target="_blank" class="clickable sublink link">LinkedIn</a></span>
				</div>
				<div in:maskSlideIn={{ delay: 850, reverse: true }}>
					<span class="button"><a href="https://github.com/vyaesop" target="_blank" class="clickable sublink link">GitHub</a></span>
				</div>
			</div>
		</div>
		<div class="profile-image" use:addSlickScrollOffset>
			{#await loadImage("assets/imgs/profile-photo.jpg") then src}
				...
				}} alt="Olyad's Profile" class="profile-pic">
			{/await}
		</div>
	{/await}
</div>
